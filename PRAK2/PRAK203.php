...
<?php
    ...
    if (isset($_POST["submit"])) {     
        ...
        // pengkondisian yang digunakan untuk memasukkan nilai suhu sesuai dengan jenis suhu awal dan suhu akhir ke dalam rumus, lalu menampilkan hasil konversi
        switch ($suhuawal) {
            // jika suhu awal adalah Celcius
            case "Celcius":
                switch ($konversisuhu) {
                    case "Celcius":
                ...
                break;
            // jika suhu awal adalah Fahrenheit
            case "Fahrenheit":
                switch ($konversisuhu) {
                    case "Celcius":
